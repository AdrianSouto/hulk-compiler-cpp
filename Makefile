...
# Compile target
compile: $(TARGET)
	@echo "Compilation completed with custom lexer. Artifacts stored in hulk/"
...
$(TARGET): $(HULK_DIR) $(PARSER_SOURCE) $(OBJECTS) $(MAIN_OBJECT) $(PARSER_OBJECT)
	...
	@echo "Hulk compiler with custom lexer built successfully in hulk/"
...
# Special rule for LexerInterface.cpp that depends on parser.hpp
build/Lexer/LexerInterface.o: src/Lexer/LexerInterface.cpp $(PARSER_HEADER) | $(BUILD_DIR)
	@mkdir -p $(dir $@)
	$(CXX) $(CXXFLAGS) $(LLVM_CXXFLAGS) -c $< -o $@

# Execute the compiled program
execute: force-regenerate $(TARGET)
	@echo "--- Running Hulk Compiler with Custom Lexer ---"
	@cd hulk && \
...
help:
	...
	@echo "  compile  - Compile the Hulk compiler with custom lexer"
	@echo "  execute  - Execute the compiled Hulk program (depends on compile)"
	@echo "  clean    - Remove all build artifacts"
	@echo "  help     - Show this help message"
	@echo ""
	@echo "This Makefile builds the Hulk compiler with a custom lexer implementation"
	@echo "that doesn't depend on flex, using automata-based tokenization."